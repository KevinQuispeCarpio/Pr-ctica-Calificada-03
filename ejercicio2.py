# 2. Crea un programa en Python que mantenga un historial de tareas pendientes. El programa debe permitir al usuario agregar una tarea al inicio de la lista, eliminar una tarea del final de la lista y mostrar todas las tareas en la lista en orden inverso al que se agregaron. 
